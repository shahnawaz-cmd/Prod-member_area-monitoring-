...
const { ReverseDecode, ClassicMappedSticker, ClassicUnmappedSticker, GenerateEUSticker } = require('../task/GenerateWindowStickers');
...
test.describe('Global Window Sticker Generation Flow', () => {
  ...
  test('CS-04 — EU Mapped VIN Sticker Generation', async ({ page }) => {
    test.setTimeout(300000);
