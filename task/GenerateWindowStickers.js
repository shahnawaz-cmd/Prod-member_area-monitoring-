...
class ReverseDecode {
  ...
  async performAs(actor) {
    ...
    // Use explicit VIN, or actor.motorcycleVin (from Mongo), or shuffle fallback
    let targetVin = this.vin || actor.motorcycleVin;
    if (!targetVin) {
...
const GenerateEUWindowSticker = require('./GenerateEUWindowSticker');
const GenerateEUSticker = GenerateEUWindowSticker;
